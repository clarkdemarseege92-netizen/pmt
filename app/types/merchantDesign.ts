...
// 类型保护函数
export function isValidMerchantCustomization(data: unknown): data is MerchantCustomization {
  return (
    typeof data === 'object' &&
    data !== null &&
    'merchant_id' in data &&
...
// 数据转换函数
export function normalizeMerchantCustomization(data: unknown): MerchantCustomization {
...
export interface ExtendedMerchantCustomization extends MerchantCustomization {
  homepage_styles?: Record<string, unknown>;
